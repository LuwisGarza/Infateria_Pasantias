...
export default function Edit({ auth, persona }) {
  ...
  const [otroRango, setOtroRango] = useState(
    persona.rango_militar && !rangosMilitares.some(r => r.value === persona.rango_militar)
  ...
  const esRangoPredefinido =
    persona.rango_militar &&
    rangosMilitares.some(r => r.value === persona.rango_militar && r.value !== '');
      ...
      header={
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold">Editar Persona</h2>
        ...
        <form onSubmit={submit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              <div className="relative">
                <select
                  value={esRangoPredefinido ? data.rango_militar : 'otro'}
                ...
                >
                  ...
                  <optgroup label="Tropa">
                    ...
                    <option value="cabo_mayor">Cabo Mayor</option>
                  </optgroup>
                  <optgroup label="Suboficiales">
                    <option value="sargento">Sargento</option>
                    <option value="sargento_primero">Sargento Primero</option>
                    <option value="sargento_mayor">Sargento Mayor</option>
                  ...
                  <optgroup label="Generales">
                    <option value="brigadier_general">Brigadier General</option>
                    <option value="general_de_brigada">General de Brigada</option>
                    <option value="general_de_division">General de División</option>
                    <option value="general_en_jefe">General en Jefe</option>
                  </optgroup>
              ...
              {(data.rango_militar === 'otro' || (!esRangoPredefinido && data.rango_militar)) && (
                <div className="mt-3">
                  <InputLabel value="Especifique el rango" className="text-gray-700" />
                  <div className="flex gap-2">
                    <TextInput
                      value={otroRango || data.rango_militar}
                      onChange={e => {
              ...
              <p className="mt-2 text-xs text-gray-500">
                Seleccione el rango militar correspondiente según la jerarquía
              </p>
            </div>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
              <div>
                <span className="font-medium">Rango actual:</span>
          ...
          <div className="flex justify-between items-center pt-4 border-t">
            <div className="flex items-center gap-4">
              <div className="text-sm text-gray-600">ID: {persona.persona_id}</div>
              <button
                type="button"
