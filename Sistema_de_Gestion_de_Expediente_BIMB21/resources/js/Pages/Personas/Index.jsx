      ...
      header={
        <div className="d-flex align-items-center justify-content-between">
          <div className="d-flex align-items-center gap-3">
            <div>
              <h2 className="h4 fw-bold mb-0">Gestión de Personal</h2>
              <p className="text-muted small mb-0">Total registradas: {personas.total}</p>
            </div>
          </div>
        </div>
      }
    >
          ...
          <div className="row align-items-center g-3">
            ...
            <div className="col-12 col-md-6">
              <div className="d-flex justify-content-md-end gap-2">
                ...
                >
                  <UserPlus size={18} />
                  <span className="d-none d-md-inline">Agregar Nuevo</span>
                </Link>
              </div>
            </div>
          </div>
                ...
                <tr key={persona.persona_id}>
                  <td className="ps-4">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <small className="text-muted">ID: {persona.persona_id}</small>
                      </div>
                    </div>
                  </td>
                  <td>
                    <div>
                      <div className="mb-1">
                        <span className="fw-medium me-1">Cédula:</span>
                        {persona.cedula}
                      </div>
                      {persona.telefono && (
                        <div className="text-muted">
                          <span className="fw-medium me-1">Tel:</span>
                          {persona.telefono}
                        </div>
                      )}
                    </div>
                  ...
                  <td className="pe-4 text-end">
                    <div className="btn-group btn-group-sm">
                      ...
                      <button
                        onClick={() => destroy(persona.persona_id)}
          ...
          <div className="card-footer bg-white border-top py-3">
            <div className="row align-items-center">
              <div className="col-12 col-md-6 mb-2 mb-md-0">
                <div className="text-muted">
                  Mostrando {filteredPersonas.length} de {personas.total} personas
                </div>
              </div>
              <div className="col-12 col-md-6">
      ...
      {filteredPersonas.length === 0 && (
        <div className="text-center py-5">
          ...
          <h3 className="h5 fw-bold text-gray-900 mb-2">No se encontraron registros</h3>
          <p className="text-muted mb-4">
            {searchTerm
              ? 'Intenta con otro término de búsqueda'
              : 'Comienza registrando a una nueva persona'}
          </p>
          {!searchTerm && (
            <Link
              href="/personas/create"
